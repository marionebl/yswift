...
public protocol YrsArrayProtocol : AnyObject {
    ...
    func getArrayAtIndex(tx: YrsTransaction, index: UInt32)  -> YrsArray?
    
    func getMapAtIndex(tx: YrsTransaction, index: UInt32)  -> YrsMap?
    
    func getScalarAtIndex(tx: YrsTransaction, index: UInt32)  -> String?
    
    func getTextAtIndex(tx: YrsTransaction, index: UInt32)  -> YrsText?
    ...
    func valueKindAtIndex(tx: YrsTransaction, index: UInt32)  -> YrsValueKind?
...
open func getArrayAtIndex(tx: YrsTransaction, index: UInt32) -> YrsArray? {
    return try!  FfiConverterOptionTypeYrsArray.lift(try! rustCall() {
    uniffi_uniffi_yniffi_fn_method_yrsarray_get_array_at_index(self.uniffiClonePointer(),
        FfiConverterTypeYrsTransaction.lower(tx),
        FfiConverterUInt32.lower(index),$0
    )
})
...
open func getMapAtIndex(tx: YrsTransaction, index: UInt32) -> YrsMap? {
    return try!  FfiConverterOptionTypeYrsMap.lift(try! rustCall() {
    uniffi_uniffi_yniffi_fn_method_yrsarray_get_map_at_index(self.uniffiClonePointer(),
        FfiConverterTypeYrsTransaction.lower(tx),
        FfiConverterUInt32.lower(index),$0
    )
})
...
open func getScalarAtIndex(tx: YrsTransaction, index: UInt32) -> String? {
    return try!  FfiConverterOptionString.lift(try! rustCall() {
    uniffi_uniffi_yniffi_fn_method_yrsarray_get_scalar_at_index(self.uniffiClonePointer(),
        FfiConverterTypeYrsTransaction.lower(tx),
        FfiConverterUInt32.lower(index),$0
    )
})
...
open func getTextAtIndex(tx: YrsTransaction, index: UInt32) -> YrsText? {
    return try!  FfiConverterOptionTypeYrsText.lift(try! rustCall() {
    uniffi_uniffi_yniffi_fn_method_yrsarray_get_text_at_index(self.uniffiClonePointer(),
        FfiConverterTypeYrsTransaction.lower(tx),
        FfiConverterUInt32.lower(index),$0
    )
})
...
open func valueKindAtIndex(tx: YrsTransaction, index: UInt32) -> YrsValueKind? {
    return try!  FfiConverterOptionTypeYrsValueKind.lift(try! rustCall() {
    uniffi_uniffi_yniffi_fn_method_yrsarray_value_kind_at_index(self.uniffiClonePointer(),
        FfiConverterTypeYrsTransaction.lower(tx),
        FfiConverterUInt32.lower(index),$0
    )
})
...
public protocol YrsMapProtocol : AnyObject {
    ...
    func getArrayAtKey(tx: YrsTransaction, key: String)  -> YrsArray?
    
    func getMapAtKey(tx: YrsTransaction, key: String)  -> YrsMap?
    
    func getScalarAtKey(tx: YrsTransaction, key: String)  -> String?
    
    func getTextAtKey(tx: YrsTransaction, key: String)  -> YrsText?
    ...
    func valueKindAtKey(tx: YrsTransaction, key: String)  -> YrsValueKind?
...
open func getArrayAtKey(tx: YrsTransaction, key: String) -> YrsArray? {
    return try!  FfiConverterOptionTypeYrsArray.lift(try! rustCall() {
    uniffi_uniffi_yniffi_fn_method_yrsmap_get_array_at_key(self.uniffiClonePointer(),
        FfiConverterTypeYrsTransaction.lower(tx),
        FfiConverterString.lower(key),$0
    )
})
...
open func getMapAtKey(tx: YrsTransaction, key: String) -> YrsMap? {
    return try!  FfiConverterOptionTypeYrsMap.lift(try! rustCall() {
    uniffi_uniffi_yniffi_fn_method_yrsmap_get_map_at_key(self.uniffiClonePointer(),
        FfiConverterTypeYrsTransaction.lower(tx),
        FfiConverterString.lower(key),$0
    )
})
...
open func getScalarAtKey(tx: YrsTransaction, key: String) -> String? {
    return try!  FfiConverterOptionString.lift(try! rustCall() {
    uniffi_uniffi_yniffi_fn_method_yrsmap_get_scalar_at_key(self.uniffiClonePointer(),
        FfiConverterTypeYrsTransaction.lower(tx),
        FfiConverterString.lower(key),$0
    )
})
...
open func getTextAtKey(tx: YrsTransaction, key: String) -> YrsText? {
    return try!  FfiConverterOptionTypeYrsText.lift(try! rustCall() {
    uniffi_uniffi_yniffi_fn_method_yrsmap_get_text_at_key(self.uniffiClonePointer(),
        FfiConverterTypeYrsTransaction.lower(tx),
        FfiConverterString.lower(key),$0
    )
})
...
open func valueKindAtKey(tx: YrsTransaction, key: String) -> YrsValueKind? {
    return try!  FfiConverterOptionTypeYrsValueKind.lift(try! rustCall() {
    uniffi_uniffi_yniffi_fn_method_yrsmap_value_kind_at_key(self.uniffiClonePointer(),
        FfiConverterTypeYrsTransaction.lower(tx),
        FfiConverterString.lower(key),$0
    )
})
...
public struct FfiConverterTypeYrsValueKind: FfiConverterRustBuffer {
    typealias SwiftType = YrsValueKind

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> YrsValueKind {
        let variant: Int32 = try readInt(&buf)
        switch variant {
    ...
    public static func write(_ value: YrsValueKind, into buf: inout [UInt8]) {
        switch value {
...
public func FfiConverterTypeYrsValueKind_lift(_ buf: RustBuffer) throws -> YrsValueKind {
    return try FfiConverterTypeYrsValueKind.lift(buf)
}

public func FfiConverterTypeYrsValueKind_lower(_ value: YrsValueKind) -> RustBuffer {
    return FfiConverterTypeYrsValueKind.lower(value)
}



extension YrsValueKind: Equatable, Hashable {}
...
fileprivate struct FfiConverterOptionTypeYrsValueKind: FfiConverterRustBuffer {
    typealias SwiftType = YrsValueKind?
    ...
    public static func write(_ value: SwiftType, into buf: inout [UInt8]) {
        ...
        writeInt(&buf, Int8(1))
        FfiConverterTypeYrsValueKind.write(value, into: &buf)
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SwiftType {
        switch try readInt(&buf) as Int8 {
        case 0: return nil
        case 1: return try FfiConverterTypeYrsValueKind.read(from: &buf)
        default: throw UniffiInternalError.unexpectedOptionalTag
        }
    }
}
...
private var initializationResult: InitializationResult {
    ...
    if (uniffi_uniffi_yniffi_checksum_method_yrsarray_get_array_at_index() != 28609) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_uniffi_yniffi_checksum_method_yrsarray_get_map_at_index() != 21765) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_uniffi_yniffi_checksum_method_yrsarray_get_scalar_at_index() != 63593) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_uniffi_yniffi_checksum_method_yrsarray_get_text_at_index() != 16895) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_uniffi_yniffi_checksum_method_yrsarray_value_kind_at_index() != 36103) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_uniffi_yniffi_checksum_method_yrsmap_get_array_at_key() != 64756) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_uniffi_yniffi_checksum_method_yrsmap_get_map_at_key() != 31019) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_uniffi_yniffi_checksum_method_yrsmap_get_scalar_at_key() != 26539) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_uniffi_yniffi_checksum_method_yrsmap_get_text_at_key() != 16244) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_uniffi_yniffi_checksum_method_yrsmap_value_kind_at_key() != 27188) {
        return InitializationResult.apiChecksumMismatch
    }
